...
char *bpc_host_name;
char *bpc_share_name;
int bpc_backup_num = -1;
int bpc_backup_compress;
int bpc_backup_prev_num = -1;
...
static struct poptOption long_options[] = {
  ...
  /* BackupPC options */
  {"bpc-top-dir",      0,  POPT_ARG_STRING, &bpc_top_dir, 0, 0, 0 },
  {"bpc-hardlink-max", 0,  POPT_ARG_INT,    &BPC_HardLinkMax, 0, 0, 0 },
  {"bpc-v3pool-used",  0,  POPT_ARG_INT,    &BPC_PoolV3Enabled, 0, 0, 0 },
  {"bpc-host-name",    0,  POPT_ARG_STRING, &bpc_host_name, 0, 0, 0 },
  {"bpc-share-name",   0,  POPT_ARG_STRING, &bpc_share_name, 0, 0, 0 },
  {"bpc-bkup-num",     0,  POPT_ARG_INT,    &bpc_backup_num, 0, 0, 0 },
  {"bpc-bkup-comp",    0,  POPT_ARG_INT,    &bpc_backup_compress, 0, 0, 0 },
  {"bpc-bkup-prevnum", 0,  POPT_ARG_INT,    &bpc_backup_prev_num, 0, 0, 0 },
