...
# Generated by GNU Autoconf 2.69 for rsync-bpc 3.1.2.2.
#
...
PACKAGE_VERSION='3.1.2.2'
PACKAGE_STRING='rsync-bpc 3.1.2.2'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures rsync-bpc 3.1.2.2 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of rsync-bpc 3.1.2.2:";;
   esac
  cat <<\_ACEOF
...
It was created by rsync-bpc $as_me 3.1.2.2, which was
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: Configuring rsync-bpc $PACKAGE_VERSION" >&5
$as_echo "$as_me: Configuring rsync-bpc $PACKAGE_VERSION" >&6;}
...
ac_log="
This file was extended by rsync-bpc $as_me 3.1.2.2, which was
generated by GNU Autoconf 2.69.  Invocation command line was
...
ac_cs_version="\\
rsync-bpc config.status 3.1.2.2
