...
# Generated by GNU Autoconf 2.69 for rsync_bpc 3.1.3.0.
#
...
PACKAGE_VERSION='3.1.3.beta0'
PACKAGE_STRING='rsync_bpc 3.1.3.beta0'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures rsync_bpc 3.1.3.beta0 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of rsync_bpc 3.1.3.beta0:";;
   esac
  cat <<\_ACEOF
...
if $ac_init_version; then
  cat <<\_ACEOF
rsync_bpc configure 3.1.3.beta0
...
It was created by rsync_bpc $as_me 3.1.3.beta0, which was
...
ac_log="
This file was extended by rsync_bpc $as_me 3.1.3.beta0, which was
generated by GNU Autoconf 2.69.  Invocation command line was
...
ac_cs_version="\\
rsync_bpc config.status 3.1.3.beta0
